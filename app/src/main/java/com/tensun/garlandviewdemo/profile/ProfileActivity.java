...
public class ProfileActivity extends AppCompatActivity {
    ...
    /** 做為參數帶入的 有View 也有資料, View只是為了轉換過程的轉場動畫使用, 資料則是要帶到ProfileActivity使用 因此要用putExtra */
    public static void start(Activity activity,
        ...
        starter.putParcelableArrayListExtra(BUNDLE_LIST_DATA, listData);                          // 传递一个序列化对象的数组
